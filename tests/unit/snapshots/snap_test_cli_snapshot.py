...
snapshots['TestCliSnapshotOutput::test_automation_help_snapshot automation_help_output'] = '''Usage: python -m warifuri automation
...
Commands:
  ...
  create-pr  Create a pull request for...
...
snapshots['TestCliSnapshotOutput::test_graph_command_help_snapshot graph_help_output'] = '''Usage: python -m warifuri graph
           [OPTIONS]
...
snapshots['TestCliSnapshotOutput::test_help_output_snapshot help_output'] = '''Usage: python -m warifuri [OPTIONS] COMMAND
                          [ARGS]...
...
Commands:
  automation  Automation and GitHub Actions...
  graph       Generate dependency graph...
  init        Initialize project or task.
  issue       Create GitHub issues for...
  list        List tasks in workspace.
  mark-done   Mark task as completed by...
  run         Run task(s).
...
snapshots['TestCliSnapshotOutput::test_init_help_snapshot init_help_output'] = '''Usage: python -m warifuri init
           [OPTIONS] [TARGET]

  Initialize project or task.

  TARGET can be: - project_name: Create new
  project - project_name/task_name: Create new
  task - Empty with --template: Expand template to
  current workspace

Options:
  --template TEXT    Template to use for
                     initialization
  --force            Overwrite existing files
  --dry-run          Show what would be created
                     without creating
  --non-interactive  Use default values without
                     prompting
  --help             Show this message and exit.
'''

snapshots['TestCliSnapshotOutput::test_issue_help_snapshot issue_help_output'] = '''Usage: python -m warifuri issue
           [OPTIONS]

  Create GitHub issues for projects and tasks.

Options:
  --project TEXT    Create parent issue for
                    project
  --task TEXT       Create child issue for
                    specific task (project/task)
  --all-tasks TEXT  Create child issues for all
                    tasks in project
  --assignee TEXT   Assign issue to user
  --label TEXT      Comma-separated labels to
                    apply
  --dry-run         Show what would be created
                    without creating
  --help            Show this message and exit.
...
snapshots['TestCliSnapshotOutput::test_mark_done_help_snapshot mark_done_help_output'] = '''Usage: python -m warifuri mark-done
           [OPTIONS] TASK_NAME
...
snapshots['TestCliSnapshotOutput::test_template_help_snapshot template_help_output'] = '''Usage: python -m warifuri template
           [OPTIONS] COMMAND [ARGS]...
