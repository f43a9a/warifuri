...
""",
    ...
    def test_graph_ascii_format(self, runner, workspace_with_dependencies):
        ...
        result = runner.invoke(cli, ["--workspace", workspace, "graph", "--format", "ascii"])
    ...
    def test_graph_mermaid_format(self, runner, workspace_with_dependencies):
        ...
        result = runner.invoke(cli, ["--workspace", workspace, "graph", "--format", "mermaid"])
    ...
    def test_graph_html_format_placeholder(self, runner, workspace_with_dependencies):
        ...
        result = runner.invoke(cli, ["--workspace", workspace, "graph", "--format", "html"])
    ...
    def test_graph_html_with_web_flag(self, runner, workspace_with_dependencies):
        ...
        result = runner.invoke(
            cli, ["--workspace", workspace, "graph", "--format", "html", "--web"]
        )
        ...
        assert (
            "Could not open browser automatically" in result.output
            or "Opening graph in web browser" in result.output
            or "Please open manually:" in result.output
        )
    ...
    def test_graph_project_filter(self, runner, workspace_with_dependencies):
        ...
        result = runner.invoke(cli, ["--workspace", workspace, "graph", "--project", "project-a"])
    ...
    def test_graph_nonexistent_project_filter(self, runner, workspace_with_dependencies):
        ...
        result = runner.invoke(
            cli, ["--workspace", workspace, "graph", "--project", "nonexistent-project"]
        )
    ...
    def test_graph_status_symbols(self, runner, workspace_with_dependencies):
        ...
        status_lines = [
            line for line in lines if any(symbol in line for symbol in ["✅", "🔄", "⏸️"])
        ]
